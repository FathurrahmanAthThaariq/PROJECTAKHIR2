                                    ...
                                    <div class="btn-group" role="group">
                                        @role('manager')
                                            ...
                                            <a href="javascript:;" class="btn btn-sm btn-primary"
                                                onclick="handle_open_modal('{{ route('backend.products.addStock', $product->id) }}', '#addStockModal', 'GET')"
                                                data-bs-toggle="tooltip" data data-bs-placement="top" title="Add Stock">

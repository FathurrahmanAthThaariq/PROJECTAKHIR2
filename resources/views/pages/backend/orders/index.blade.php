...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold">
        ...
        <!--begin::Item-->
        <li class="breadcrumb-item text-white fw-bold lh-1">
            <a href="{{ route('backend.orders.index') }}" class="text-white">Orders</a>
        </li>
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-white fw-bold lh-1">All Orders</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
                            ...
                            <tr>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <span class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="background-image:url({{ asset($order->user->avatar) }})">
                                            </span>
                                        </span>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                            ...
                                            <span class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1"
                                                data-user-filter="user_name">{{ $order->user->name }}</span>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <span class="text-gray-800 fw-bolder d-block fs-6"
                                        data-order-filter="order_total">{{ $order->total }}</span>
                                </td>
                                <!--end::Total=-->
                                <!--begin::Status=-->
                                <td>
                                    <span
                                        class="badge badge-light-{{ $order->status == 'pending' ? 'warning' : ($order->status == 'success' ? 'success' : 'danger') }} fw-bolder">{{ $order->status }}</span>
                                </td>
                                <!--end::Status=-->
                                <!--begin::Action=-->
                                <td class="text-end">
                                    <div class="btn-group" role="group">
                                        ...
                                        <a href="javascript:;" class="btn btn-sm btn-primary"
                                            onclick="handle_confirm('Apakah Anda Yakin?','Yakin','Tidak','PUT','{{ route('backend.orders.approve', $order->id) }}')">
                                        ...
                                        <a href="javascript:;" class="btn btn-sm btn-danger"
                                            onclick="handle_confirm('Apakah Anda Yakin?','Yakin','Tidak','PUT','{{ route('backend.orders.reject', $order->id) }}')">
